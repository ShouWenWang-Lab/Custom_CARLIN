classdef (Sealed) CARLIN_def < handle        
    ...
    properties (Constant, GetAccess=private)
        ...
        pam = 'GACTCCA'; 
        postfix = 'C'; % this is not right. Does it matter?, part of CARLIN sequnece
        ...
        SecondarySequence = 'GGCGATTCGCGAGGTACCGA'; %after postfix, and before Primer3, not part of CARLIN SEQ, used to ensure the whole sequence is read 
    end
    ...
    methods (Access = private)
        ...
        function obj = CARLIN_def
            ...
            obj.match_score.SecondarySequence = 25; % test this please, orignal: 30; we found that 27 is the critical number for our data
