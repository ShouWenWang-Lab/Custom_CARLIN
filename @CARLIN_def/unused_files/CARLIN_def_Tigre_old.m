classdef (Sealed) CARLIN_def < handle
    ...
    %% CARLIN Sequence. Check with the plasmid of the new CARLIN for its interpretation.
    properties (Constant, GetAccess=private)
        % below, we reversed the Tigre carlin sequence, as Li has attached the UMI to the end of the sequence 
        ...
        prefix = 'A';%between Primer5 and first CARLIN segment
        pam = 'GACTCCA'; 
        postfix = 'CGGCG'; % this is not right. Does it matter?
        Primer5 = 'ACCGACA'; % the very beginning, TAGAAGGCACCGACA 
        Primer3 = 'AGGTACCGAG';
        SecondarySequence = 'ATTCGCG'; %after postfix, and before Primer3
    end
